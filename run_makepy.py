...
def generate_hwp_wrapper():
    ...
    try:
        ...
        print(
            "If no errors were shown above, the wrapper was likely created or updated successfully."
        )
        ...
        print(
            "This might happen if the HWP Type Library is not found in the system registry."
        )
...
if __name__ == "__main__":
    ...
    if os.path.exists(gen_py_path):
        ...
        print(
            "It is highly recommended to delete this folder for a clean regeneration."
        )
